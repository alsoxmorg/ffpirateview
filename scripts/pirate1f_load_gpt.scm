...
;;attempted to register the menu item "<Load>" for procedure "script-fu-load-1fpirate".
;;The menu label given in gimp_install_procedure() already contained a path.  To make
;;this work, pass just the menu's label to gimp_install_procedure().



(define (script-fu-load-1fpirate filename)
  (let* (
...
(script-fu-register
 ...
 "<Load>/1fpirate"
 "Load a .1f image (1-bit farbfeld format)"
 "You"
 "Public Domain"
 "2025"
 ""
